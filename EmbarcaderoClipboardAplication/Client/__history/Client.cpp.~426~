...
{
ShowMessage("Socket Error: " + IntToStr(ErrorCode) +" Event: " + IntToStr((int)ErrorEvent));
ErrorCode = 0;
...

{
	...
	mesajeClient->InterpreteazaMesaj(receivedText, CasutaText);
}
//---------------------------------------------------------------------------
...
TPresets *Presets=new TPresets(this);
 try
	{
        ShowMessage("In mod default se va incarca Preset");
		Presets->ShowModal();
